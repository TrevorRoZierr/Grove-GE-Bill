...
export default function Header() {
  ...
  return (
    <header>
      <nav className="flex justify-between items-center h-20 px-4 shadow-md bg-lime-200 text-black">
        <Link href="/" className="text-lg font-bold uppercase ml-8">
          Grove-St. Menu
        </Link>
        <div>
          ...
          <Link href="/cart" className="flex justify-between items-end">
            ...
            <h1 className="ml-3 uppercase font-semibold">Bill</h1>
          </Link>
